...
public class DaemonThreadwithThreadSafeArryList extends Thread{
	
	private ThreadSafetyArrayListDemo _printRecord; 
	public DaemonThreadwithThreadSafeArryList(ThreadSafetyArrayListDemo Candidates){
